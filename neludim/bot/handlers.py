...
def start_text(context):
    return f'''Бот @betterdatacommunity_rc_bot организует random coffee для сообщества @betterdatacommunity.
...
HELP_TEXT = '''Бот @betterdatacommunity_rc_bot организует random coffee для сообщества @betterdatacommunity.

<b>Как это работает?</>
- Участник чата @betterdatacommunity запускает бота, заполняет анкету. Алгоритм объединяет людей в пары.
...
- Привет, бот дал твой контакт. Когда удобно встретиться/созвониться на этой неделе? Могу в будни после 17.
- Ты в Сбере на Кутузовской? Можно там. Когда удобно? Могу в среду, четверг после 18.
